...
repository during onboarding, it opens a pull request that adds tracing to your app — so you can
...
2. Detects your framework and model setup and adds tracing.
